...
GORILLA::DynamicTriggerInfo parseTrigger(nlohmann::json& j)
{
  ...
  GORILLA::DynamicTriggerInfo tgInfo(funcNameCheck, ParametersCheck, funcNameCompare,
    ParametersCompare, funcNameAction, ParametersAction);
...
int main(int argc, char** argv)
{
  ...
  for (nlohmann::json::iterator it = j.begin(); it != j.end(); ++it)
  {
    ...
    std::string triggerMasterAddr =
      uniclient->registerTrigger(dims, indexlb, indexub, triggerName, dti);
